...
#+begin_src emacs-lisp
  (use-package ivy
    ...
    :bind (("C-s" . swiper)
           ...
           ("C-c C-f" . counsel-buffer-or-recentf) ; open recent file or buffer
...
Having trouble getting this to work. Debugger won't attach to session/stack-frame.
...
#+begin_src emacs-lisp
  ...
  ;;           :request "launch"
  ;;           :cwd "/home/grish/hub/new_projects/interview_prep/cpp/"
  ;;           :program "/home/grish/hub/new_projects/interview_prep/cpp/reverse_string"
