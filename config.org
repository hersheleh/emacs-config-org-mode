...
#+begin_src emacs-lisp
  ...
  (defvar my-sage-arch-p (equal (system-name) "sage"))
...
#+begin_src emacs-lisp
  (use-package org
    ...
    (setq org-default-notes-file "~/hub/orgs/capture.org")
    (setq org-agenda-files
          '(
            ...
            "~/hub/orgs/social.org"
            "~/hub/orgs/job.org"
            "~/hub/orgs/work/perfect_circuit.org"
...
#+begin_src emacs-lisp
  (use-package org-pomodoro
    ...
    (let ((prefix "")
      ...
      (cond (my-sage-arch-p (setq prefix "/home/grisha/"))
            (my-sc-thinkpad-p (setq prefix "/home/grish/"))
...
#+begin_src emacs-lisp
  (defvar my/reactor-root "/home/grisha/hub/perfect_circuit/reactor-18"
    "Project root for reactor dape configs.")
  (defun my/dape-node-base ()
    (list 'modes '(js2-mode js-ts-mode typescript-mode typescript-ts-mode)
          'ensure 'dape-ensure-command
          'fn 'dape-config-autoport
          'command "node"
          'command-cwd 'dape-command-cwd
          'command-args (list (expand-file-name
  ...
  (defun my/dape-register-node (name &rest overrides)
    (setf (alist-get name dape-configs)
          (append overrides (my/dape-node-base))))
  ...
  (use-package dape
    ...
    (my/dape-register-node
     'reactor-file
     :runtimeExecutable "npm"
     :env '(:NODE_ENV "development")
     :runtimeArgs (lambda ()
                    (vector "run" "runWithMongo" "--"
                            (or (buffer-file-name)
    ...
    (my/dape-register-node
     ...
     :program (expand-file-name "node_modules/mocha/bin/mocha.js" my/reactor-root)
     :args (lambda ()
             (vector "--no-timeouts"
                     (or (buffer-file-name)
                         (user-error "Current buffer is not visiting a test file")))))
    (my/dape-register-node
     'mocha-grep
     :autoAttachChildProcesses t
     :program (expand-file-name "node_modules/mocha/bin/mocha.js" my/reactor-root)
     :args (lambda ()
             (vector "--no-timeouts" "--grep" (read-string "mocha --grep: ")
                     (or (buffer-file-name)
                         (user-error "Current buffer is not visiting a test file")))))
    )
    ;; (add-to-list 'dape-configs
    ;;              `(npm-noworker
    ;;                modes (js2-mode js-ts-mode typescript-mode typescript-ts-mode)
    ;;                ensure dape-ensure-command
    ;;                fn dape-config-autoport
    ;;                command "node"
    ;;                command-cwd dape-command-cwd
    ...
    ;;                :type "pwa-node"
    ;;                :request "launch"
    ;;                :cwd "/home/grisha/hub/perfect_circuit/reactor-18"
    ;;                :runtimeExecutable "npm"
    ;;                :runtimeArgs ["run" "noworker"]
    ;;                :console "integratedTerminal"
    ;;                :outputCapture "console"
    ...
    ;;                :request "launch"
    ;;                :cwd "/home/grisha/hub/perfect_circuit/reactor-18"
    ;;                :program "/home/grisha/hub/perfect_circuit/reactor-18/node_modules/mocha/bin/mocha.js"
    ;;                :args ,(lambda ()
    ;;                         (vector "--no-timeouts"
    ;;                                 (or (buffer-file-name)
    ;;                                     (user-error "Current buffer is not visiting a test file"))))
    ;;                :autoAttachChildProcess t
    ;;                :console "integratedTerminal"
    ;;                :outputCapture: "console"
    ;;                :skipFiles ["<node_internals>/**"]
    ;;                ))
...
#+begin_src emacs-lisp
  (use-package sclang
    ...
    (lambda ()
      (cond
       (my-sage-arch-p "/home/grisha/.local/share/SuperCollider/downloaded-quarks/scel/el")
       (my-steam-deck-p
  ...
  (use-package ob-sclang
    ...
    (lambda ()
      (cond
       ...
       (my-sage-arch-p "/home/grisha/.emacs.d/git-lisp/ob-sclang/")))
    :config
    (org-babel-do-load-languages 'org-babel-load-languages
                                 (append org-babel-load-languages
                                         '((sclang . t)))))
...
#+begin_src emacs-lisp
  ...
  (use-package nov
    ...
    (nov-text-width t))
#+end_src
* COMMENT Structure & Interpretation of Computer Programs
#+begin_src emacs-lisp
  (use-package sicp
    :demand t)
#+end_src
* DevDocs.IO
A package to search documentation offline
#+begin_src emacs-lisp
  (use-package devdocs
